...
export default function RecoilTodoPanel() {
  ...
  return (
    <div className="w-full max-w-md bg-gray-800 rounded-lg p-6 mt-8 shadow">
      <h2 className="text-2xl font-semibold mb-4">🧬 Recoil Todo</h2>

      {/* Add */}
      <div className="flex gap-2 mb-4">
        <input
          className="flex-1 px-3 py-2 rounded bg-gray-700 border border-gray-600 focus:outline-none focus:ring-2 focus:ring-emerald-500"
